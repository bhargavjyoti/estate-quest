  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto'>
        <h1 className="text-slate-700 font-bold text-3xl lg:text-6xl">Your Home, Your Way: <br />Buy or Rent Properties Seamlessly!</h1>
        <div className='text-gray-400 text-xs sm:text-sm'>
          Estate Quest is the best place to find your next perfect place to live.
          <br />
